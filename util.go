...
func UpsertAttachmentGen(upsertAttachmentGQL string, attachmentName string, attachmentUuid string, attachmentGen int64, attachmentMime string, attachmentInstance int, attachmentUser string, contractId int, endpoint string, adminSecret string, bearer string) (int, string, error) {
...
func FileUpsert(file *bufio.Reader, instance int, fileName string, mime string, user string, uuidString string, contractID int, bucket string, upsertAttachmentGQL string, endpoint string, adminSecret string, bearer string) (int, string, int64, error) {
	...
	id, uuid, err := UpsertAttachmentGen(upsertAttachmentGQL, fileName, ustr, gen, mime, instance, user, contractID, endpoint, adminSecret, bearer)
	if err != nil {
